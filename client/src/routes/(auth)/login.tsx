  ...
  return (
    <div className="dark min-h-screen overflow-hidden bg-zinc-950 text-zinc-50">
      <div className="relative isolate min-h-screen">
        ...
        <main className="relative mx-auto grid min-h-screen max-w-7xl items-start gap-8 px-4 py-6 sm:items-center sm:gap-10 sm:px-6 sm:py-10 lg:grid-cols-[0.9fr_1.1fr] lg:px-10">
          <section className="order-2 space-y-5 pb-4 lg:order-2 lg:space-y-6 lg:pl-8">
            <div className="space-y-3 sm:space-y-4">
              ...
              <h1 className="max-w-xl text-3xl font-semibold leading-tight tracking-tight text-white sm:text-5xl">
                Drop back in and take control of the board.
              </h1>
              <p className="max-w-2xl text-sm leading-6 text-zinc-300 sm:text-lg sm:leading-7">
                Sign in to launch new polls, watch responses roll in live, and
                keep your feedback sessions moving without losing momentum.
              </p>
            </div>
            ...
            <div className="grid gap-3 sm:grid-cols-2 sm:gap-4">
              <FeatureTile
                icon={Sparkles}
                title="Resume fast"
                description="Jump straight back into your workspace and keep your audience flow alive."
              />
              <FeatureTile
                icon={TimerReset}
                title="Stay in sync"
                description="Get back to live polls, active sessions, and fresh response updates in one step."
              />
            </div>
          </section>
              ...
              <CardHeader className="space-y-3 px-4 pt-4 sm:space-y-3">
                ...
                <div className="space-y-1">
                  <CardTitle className="font-heading text-base leading-relaxed text-white sm:text-xl">
                    Sign in to Pulse-Board
                  </CardTitle>
                  <CardDescription className="text-sm leading-6 text-zinc-400 sm:text-base">
                    Enter your credentials and head straight to your workspace.
                  </CardDescription>
                </div>
              </CardHeader>
        ...
        <AlertDialogContent className="border border-red-400/20 bg-zinc-900 text-zinc-50">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-zinc-400">
              {errorMessage ||
                'We could not sign you in. Please review your credentials and try again.'}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogAction
